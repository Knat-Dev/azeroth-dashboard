export default () => {
  ...
  if (soapUser === 'admin' && soapPassword === 'admin' && process.env.NODE_ENV === 'production') {
    console.warn('[WARN] SOAP using default admin/admin credentials. Set SOAP_USER and SOAP_PASSWORD in .env.');
  }
